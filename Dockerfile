...
# ps1
RUN echo "PS1='\[\033[44;37m\]NOETIC\[\033[0m\]:\[\033[32m\]\u@\h\[\033[0m\]:\[\033[1;33m\]\w\[\033[0m\]$ '" >> /home/${USER_NAME}/.bashrc ;\
...
# package download and build
COPY tb3_common /home/${USER_NAME}/catkin_ws/src/tb3_common
COPY tb3_navigation /home/${USER_NAME}/catkin_ws/src/tb3_navigation
#COPY roomba_planner /home/${USER_NAME}/catkin_ws/src/roomba_planner
#COPY ros_fuzzy_controller /home/${USER_NAME}/catkin_ws/src/ros_fuzzy_controller
